...
#import "BaoyouViewController.h"
#import <WebKit/WebKit.h>

@interface BaoyouViewController ()<WKNavigationDelegate,WKScriptMessageHandler,WKUIDelegate,UIScrollViewDelegate>
...
@implementation BaoyouViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    _webviewUrl = @"http://www.youjiequ.com/index.php?r=nine/wap";
...
#pragma mark - 返回上一页不会调用didfinish方法，会调用didcommit开始加载方法
