...
@interface MallViewController ()<WKNavigationDelegate,WKScriptMessageHandler,WKUIDelegate,UIScrollViewDelegate>
...
- (void)viewDidLoad {
    [super viewDidLoad];
    _webviewUrl = @"http://www.youjiequ.com/index.php?r=index/wap";
